...
export default function VideoMeetComponent() {
    ...
    let handleVideo = () => {
        const updatedVideoState = !video;
        setVideo(updatedVideoState);
        ...
        if (updatedVideoState) {
            ...
            navigator.mediaDevices.getUserMedia({ video: true, audio: audio })
                .then(stream => {
                    ...
                    // Replace stream for all connections
                    for (let id in connections) {
            ...
            // Turn OFF video — replace with black track
            ...
            for (let id in connections) {
                const sender = connections[id].getSenders().find(s => s.track.kind === "video");
                if (sender) {
                    sender.replaceTrack(blackSilenceStream.getVideoTracks()[0]);
                }
            }
